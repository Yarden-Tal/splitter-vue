  ...
  <div>
    ...
    <div>
      ...
      <div class="icon-parent">
        ...
        <input type="number" name="bill" :value="store.bill" max="999999"
        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  maxlength="6"
          @input="(e) => store.updateBill(Number((e.target as HTMLInputElement).value))" class="input-field"
          inputmode="decimal">
      </div>
    </div>
    <!-- Tip -->
    ...
    <div class="mt">
      ...
      <div class="icon-parent">
        ...
        <input type="number" :value="store.people"
          @input="(e) => store.updatePeople(Number((e.target as HTMLInputElement).value))" min="1" max="100"
          inputmode="numeric" name="people" class="input-field">
      </div>
    </div>
  </div>
</template>
